...
val inline map2:
  [<InlineIfLambda>] mapping: ('a -> 'b -> 'c) ->
    ...
    result2: Result<'b,'e list> -> Result<'c,'e list>
...
val inline mapErrors:
  [<InlineIfLambda>] mapping: ('e -> 'f) ->
    result: Result<'a,'e list> -> Result<'a,'f list>
...
val inline (<*>) :
  application: Result<('a -> 'b),'e list> ->
    result: Result<'a,'e list> -> Result<'b,'e list>
...
val inline (>>=) :
  result: Result<'a,'e> ->
    [<InlineIfLambda>] binder: ('a -> Result<'b,'e>) -> Result<'b,'e>
...
val inline traverse:
  [<InlineIfLambda>] traverser: ('a -> Result<'b,'e list>) ->
    source: 'a seq -> Result<'b list,'e list>
...
val inline sequence: source: Result<'a,'b list> seq -> Result<'a list,'b list>
...
val inline try':
  f: ('a -> 'b) ->
    [<InlineIfLambda>] emap: (exn -> 'e) -> p: 'a -> Result<'b,'e>
...
type FunctorBuilder =
    ...
    member
      inline BindReturn: result: Result<'a,'e> * mapping: ('a -> 'b) ->
                           Result<'b,'e>
...
type ApplicativeBuilder =
    ...
    member
      inline MergeSources: result1: Result<'a,'e list> *
...
type MonadBuilder =
    ...
    member
      inline Bind: result: Result<'a,'e> * binder: ('a -> Result<'b,'e>) ->
                     Result<'b,'e>
...
[<System.Obsolete>]
val traverseListFirstError:
  traverser: ('a -> Result<'b,'e>) -> list: 'a list -> Result<'b list,'e>

[<System.Obsolete>]
val traverseSeqFirstError:
  traverser: ('a -> Result<'b,'e>) -> source: 'a seq -> Result<'b list,'e>
